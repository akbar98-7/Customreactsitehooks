    ...
    return (
        <>
            ...
            <div className='d-flex justify-content-center'>
                <h4 className='px-3 align-items-center text-white'>contact@lettingahead.com</h4>

            </div>

            <div className='d-flex justify-content-center'>
                <h4 className='px-3 align-items-center text-white'>0333 242 0839</h4>
            ...
            <div>
                <p className='text-center fs-3 text-white'>Copyright © 2026 Lettings Hub. All rights reserved.</p>
            </div>
        </>
    )
}
